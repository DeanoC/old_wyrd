...
VIRTUALKEY_KEY_MAP2(LMENU, LMENU, COMMAND)
VIRTUALKEY_KEY_MAP2(LWIN, LWIN, OPTION)
VIRTUALKEY_KEY_MAP2(RWIN, RWIN, RIGHTOPTION)

// mac doesn't have keycodes for this
VIRTUALKEY_KEY_MAP2(RMENU, RMENU, COMMAND)
...
VIRTUALKEY_KEY_MAP2(PRINTSCREEN, SYSRQ, F13)
