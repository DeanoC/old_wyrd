...
float3 Fn_R_F3I(out float3 p)
{
	p = i3;
	return i3;
}

float3 Fn_R_F3U(out float3 p)
{
	p = u3;
	return u3;
}

float3 Fn_R_F3B(out float3 p)
{
	p = b3;
	return b3;
}

float3 Fn_R_F3D(out float3 p)
{
	p = d3;
	return d3;
}  // valid, but loss of precision on downconversion.

int3 Fn_R_I3U(out int3 p)
{
	p = u3;
	return u3;
}

int3 Fn_R_I3B(out int3 p)
{
	p = b3;
	return b3;
}

int3 Fn_R_I3F(out int3 p)
{
	p = f3;
	return f3;
}

int3 Fn_R_I3D(out int3 p)
{
	p = d3;
	return d3;
}  // valid, but loss of precision on downconversion.

uint3 Fn_R_U3I(out uint3 p)
{
	p = i3;
	return i3;
}

uint3 Fn_R_U3F(out uint3 p)
{
	p = f3;
	return f3;
}

uint3 Fn_R_U3B(out uint3 p)
{
	p = b3;
	return b3;
}

uint3 Fn_R_U3D(out uint3 p)
{
	p = d3;
	return d3;
}  // valid, but loss of precision on downconversion.

bool3 Fn_R_B3I(out bool3 p)
{
	p = i3;
	return i3;
}

bool3 Fn_R_B3U(out bool3 p)
{
	p = u3;
	return u3;
}

bool3 Fn_R_B3F(out bool3 p)
{
	p = f3;
	return f3;
}

bool3 Fn_R_B3D(out bool3 p)
{
	p = d3;
	return d3;
}

double3 Fn_R_D3I(out double3 p)
{
	p = i3;
	return i3;
}

double3 Fn_R_D3U(out double3 p)
{
	p = u3;
	return u3;
}

double3 Fn_R_D3B(out double3 p)
{
	p = b3;
	return b3;
}

double3 Fn_R_D3F(out double3 p)
{
	p = f3;
	return f3;
}
