...
register_liveness->
ComputeLoopRegisterPressure(* ld[39], & loop_reg_pressure
);
...
register_liveness->
SimulateFusion(* ld[17], * ld[39], & simulation_resut
);
...
register_liveness->
SimulateFission(* ld[21], moved_instructions,
