...
SinglePassRunAndCheck<LocalSingleStoreElimPass>(predefs
+ before,
...
SinglePassRunAndCheck<LocalSingleStoreElimPass>(assembly, assembly,
true,
true);
}
...
SinglePassRunAndCheck<LocalSingleStoreElimPass>(before, after,
true, true);
}
