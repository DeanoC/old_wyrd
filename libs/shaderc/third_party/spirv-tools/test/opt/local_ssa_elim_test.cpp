...
SinglePassRunAndCheck<LocalMultiStoreElimPass>(predefs
+ before,
...
SinglePassRunAndCheck<LocalMultiStoreElimPass>(
		predefs
+ names + predefs2 + before, predefs + names + predefs2 + after,
true, true);
}
...
SinglePassRunAndCheck<LocalMultiStoreElimPass>(before, before,
true, true);
}
...
SinglePassRunAndCheck<LocalMultiStoreElimPass>(
		predefs
+ func_before, predefs + func_after, true, true);
}
...
SinglePassRunAndCheck<LocalMultiStoreElimPass>(before, after,
true, true);
}
