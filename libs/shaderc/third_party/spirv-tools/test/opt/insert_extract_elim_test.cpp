...
SinglePassRunAndCheck<SimplificationPass>(predefs
+ before, predefs + after,
true, true);
}
...
SinglePassRunAndCheck<SimplificationPass>(assembly, assembly,
true, true);
}
...
SinglePassRunAndCheck<SimplificationPass>(before_predefs
+ before,
...
SinglePassRunAndCheck<SimplificationPass>(predefs_before
+ before,
