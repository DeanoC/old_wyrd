...
EXPECT_EQ(MakeFilterIterator(data.begin(), data.end(), pred)
.
Get(),
		data
.
...
EXPECT_EQ(MakeFilterIterator(data.end(), data.end(), pred)
.
Get(), data
.
end()
