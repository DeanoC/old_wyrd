...
EXPECT_EQ(& block, analysis
->
CommonDominator(& block, & block
));
}
}
...
EXPECT_EQ(
		...
		analysis
->
CommonDominator(GetBlock(1u, context), GetBlock(2u, context)
));
EXPECT_EQ(
		GetBlock(2u, context),
		analysis
->
CommonDominator(GetBlock(2u, context), GetBlock(5u, context)
));
EXPECT_EQ(
		GetBlock(1u, context),
		analysis
->
CommonDominator(GetBlock(1u, context), GetBlock(5u, context)
));
}
...
EXPECT_EQ(
		...
		analysis
->
CommonDominator(GetBlock(7u, context), GetBlock(8u, context)
));
EXPECT_EQ(
		GetBlock(3u, context),
		analysis
->
CommonDominator(GetBlock(7u, context), GetBlock(9u, context)
));
}
...
EXPECT_EQ(
		...
		analysis
->
CommonDominator(GetBlock(3u, context), GetBlock(4u, context)
));
}
...
EXPECT_EQ(nullptr, analysis->
CommonDominator(GetBlock(10u, context),
		GetBlock(11u, context)
));
EXPECT_EQ(nullptr, analysis->
CommonDominator(GetBlock(11u, context),
		GetBlock(6u, context)
));
}
