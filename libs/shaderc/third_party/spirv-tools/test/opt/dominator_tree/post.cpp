...
EXPECT_FALSE(analysis
->StrictlyDominates(19, 19));

EXPECT_TRUE(analysis
->StrictlyDominates(19, 18));
EXPECT_TRUE(analysis
->StrictlyDominates(19, 5));
EXPECT_TRUE(analysis
->StrictlyDominates(19, 53));
EXPECT_TRUE(analysis
->StrictlyDominates(19, 25));
EXPECT_TRUE(analysis
->StrictlyDominates(19, 29));
EXPECT_TRUE(analysis
->StrictlyDominates(19, 27));
EXPECT_TRUE(analysis
->StrictlyDominates(19, 26));
EXPECT_TRUE(analysis
->StrictlyDominates(19, 28));
...
EXPECT_FALSE(analysis
->StrictlyDominates(5, 18));
EXPECT_FALSE(analysis
->StrictlyDominates(5, 53));
EXPECT_FALSE(analysis
->StrictlyDominates(5, 19));
EXPECT_FALSE(analysis
->StrictlyDominates(5, 25));
EXPECT_FALSE(analysis
->StrictlyDominates(5, 29));
EXPECT_FALSE(analysis
->StrictlyDominates(5, 27));
EXPECT_FALSE(analysis
->StrictlyDominates(5, 26));
EXPECT_FALSE(analysis
->StrictlyDominates(5, 28));
}
