...
EXPECT_TRUE(analysis
->StrictlyDominates(12, 14));
EXPECT_TRUE(analysis
->StrictlyDominates(12, 11));
EXPECT_TRUE(analysis
->StrictlyDominates(12, 10));
EXPECT_TRUE(analysis
->StrictlyDominates(12, 5));
EXPECT_TRUE(analysis
->StrictlyDominates(14, 10));
EXPECT_TRUE(analysis
->StrictlyDominates(14, 5));
EXPECT_TRUE(analysis
->StrictlyDominates(10, 5));
}
