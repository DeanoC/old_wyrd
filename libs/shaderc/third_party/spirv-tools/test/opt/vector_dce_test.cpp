...
SinglePassRunAndCheck<VectorDCE>(before_predefs
+ before,
...
SinglePassRunAndCheck<DeadInsertElimPass>(before_predefs
+ before,
after_predefs + after, true, true);
}
...
SinglePassRunAndCheck<DeadInsertElimPass>(before, before,
true, true);
}
...
SinglePassRunAndCheck<DeadInsertElimPass>(text, text,
true, true);
}
