...
.
GetDependence(context
->get_def_use_mgr()->GetDef(29),
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(33), store[0], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(44), store[1], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(54), store[2], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(61), store[3], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(78), store[0], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(85), store[1], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(92), store[2], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(99), store[3], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(49), store[0], &distance_vector));
}
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(84), store[2], &distance_vector));
}
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(101), store[3], &distance_vector));
}
}
// For the loop in function b.
{
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(129), store[0], &distance_vector));
}
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(140), store[1], &distance_vector));
}
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(157), store[2], &distance_vector));
}
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(174), store[3], &distance_vector));
}
}
}
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(34), store[0], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
DistanceEntry::DependenceInformation::PEEL);
EXPECT_TRUE(distance_vector
.
GetEntries()[0]
.peel_first);
}
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(38), store[1], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(43), store[2], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(47), store[3], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(66), store[0], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(70), store[1], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(74), store[2], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(78), store[3], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(93), store[0], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(97), store[1], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(101), store[2], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(105), store[3], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(120), store[0], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(124), store[1], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(128), store[2], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(132), store[3], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
GetDependence(
		context
->get_def_use_mgr()->GetDef(39), store[0], &distance_vector));
EXPECT_EQ(distance_vector
.
GetEntries()[0]
.dependence_information,
...
const Instruction& inst
: *
spvtest::GetBasicBlock(f, block_id
)) {
if(inst.
opcode()
== SpvOp::SpvOpStore) {
...
CheckDependenceAndDirection(load[0], store[0],
false, dependent, &analysis);
CheckDependenceAndDirection(load[1], store[1],
false, dependent, &analysis);
CheckDependenceAndDirection(load[2], store[2],
false, dependent, &analysis);
CheckDependenceAndDirection(load[3], store[3],
false, dependent, &analysis);
CheckDependenceAndDirection(load[4], store[4],
true, independent, &analysis);
CheckDependenceAndDirection(load[5], store[5],
false, dependent, &analysis);
CheckDependenceAndDirection(load[6], store[6],
false, dependent, &analysis);
CheckDependenceAndDirection(load[7], store[7],
false, dependent, &analysis);
CheckDependenceAndDirection(load[8], store[8],
true, independent, &analysis);
CheckDependenceAndDirection(load[9], store[9],
false, dependent, &analysis);
CheckDependenceAndDirection(load[10], store[10],
false, dependent, &analysis);
CheckDependenceAndDirection(load[11], store[11],
false, dependent, &analysis);
CheckDependenceAndDirection(load[12], store[12],
false, dependent, &analysis);
CheckDependenceAndDirection(load[13], store[13],
true, independent,
&analysis);
CheckDependenceAndDirection(load[14], store[14],
true, independent,
&analysis);
CheckDependenceAndDirection(load[15], store[15],
true, independent,
&analysis);
CheckDependenceAndDirection(load[16], store[16],
true, independent,
&analysis);
}
...
PartitionSubscripts(load[0], store[0], & analysis,
{
{
0
}, {
...
PartitionSubscripts(load[1], store[1], & analysis,
{
{
0
}, {
...
PartitionSubscripts(load[2], store[2], & analysis,
{
{
0, 1
}, {
...
PartitionSubscripts(load[3], store[3], & analysis,
{
{
0, 3
}, {
...
PartitionSubscripts(load[4], store[4], & analysis,
{
{
0
}, {
...
PartitionSubscripts(load[5], store[5], & analysis,
{
{
0, 1
}, {
...
PartitionSubscripts(load[6], store[6], & analysis,
{
{
0, 1, 2
}, {
...
PartitionSubscripts(load[7], store[7], & analysis,
{
{
0, 1, 2, 3
}
});
PartitionSubscripts(load[8], store[8], & analysis,
{
{
0
}, {
...
PartitionSubscripts(load[9], store[9], & analysis,
{
{
0
}, {
...
PartitionSubscripts(load[10], store[10], & analysis,
{
{
0, 1, 2, 3
}
});
PartitionSubscripts(load[11], store[11], & analysis,
{
{
0, 1
}, {
...
PartitionSubscripts(load[12], store[12], & analysis,
{
{
0, 2
}, {
...
EXPECT_EQ(* x, * ret_point_0
->
GetSource()
);
EXPECT_EQ(* y, * ret_point_0
->
GetDestination()
);
...
EXPECT_EQ(* x, * ret_point_1
->
GetSource()
);
EXPECT_EQ(* y, * ret_point_1
->
GetDestination()
);
}
...
EXPECT_NE(nullptr, ret_2->
AsDependenceEmpty()
);
EXPECT_NE(nullptr, ret_3->
AsDependenceEmpty()
);
...
EXPECT_NE(nullptr, ret_4->
AsDependenceEmpty()
);
EXPECT_NE(nullptr, ret_5->
AsDependenceEmpty()
);
}
...
EXPECT_NE(nullptr, ret_6->
AsDependenceNone()
);
EXPECT_NE(nullptr, ret_7->
AsDependenceNone()
);
}
...
EXPECT_NE(nullptr, ret_y_same_0->
AsDependenceLine()
);
...
EXPECT_NE(nullptr, ret_y_same_1->
AsDependenceLine()
);
...
EXPECT_NE(nullptr, ret_2x_2_2x_1->
AsDependenceEmpty()
);
...
EXPECT_NE(nullptr, ret_2x_2_x_1->
AsDependenceLine()
);
...
EXPECT_NE(nullptr, ret_x_same_0->
AsDependenceLine()
);
...
EXPECT_NE(nullptr, ret_x_same_1->
AsDependenceLine()
);
EXPECT_EQ(* line_x_1, * ret_x_same_1
->
AsDependenceLine()
);
...
EXPECT_NE(nullptr, ret_xy_0_x_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_xy_0_y_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_xy_0_x_1->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_xy_0_y_1->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_x_0_xy_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_y_0_xy_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_x_1_xy_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_y_1_xy_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_xy_1_x_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_xy_1_y_0->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_xy_1_x_1->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_xy_1_y_1->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_x_0_xy_1->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_y_0_xy_1->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_x_1_xy_1->
AsDependencePoint()
);
...
EXPECT_NE(nullptr, ret_y_1_xy_1->
AsDependencePoint()
);
