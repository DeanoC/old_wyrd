...
input;
// Now check the round trip through the disassembler.
EXPECT_THAT(EncodeAndDecodeSuccessfully(input), Eq(expected)
) <<
input;
}
...
INSTANTIATE_TEST_CASE_P(
		...
		::testing::ValuesIn(std::vector<InstructionCase>({
																 ...
																 CASE_ISF(TypePointer,
																		  Function,
																		  "FlagIsProtected|FlagIsPrivate",
																		  uint32_t(DebugInfoFlagIsProtected) |
																				  uint32_t(DebugInfoFlagIsPrivate)),
																 CASE_ISF(
...
INSTANTIATE_TEST_CASE_P(
		...
		::testing::ValuesIn(std::vector<InstructionCase>({
																 ...
																 CASE_IEILLIIF(TypeComposite,
																			   ...
																			   uint32_t(DebugInfoFlagIsPrivate)),
																 // Now add members
																 CASE_IEILLIIFI(TypeComposite,
																				Class,
																				9,
																				10,
																				"FlagIsPrivate",
																				uint32_t(DebugInfoFlagIsPrivate)),
																 CASE_IEILLIIFII(TypeComposite,
																				 Class,
																				 9,
																				 10,
																				 "FlagIsPrivate",
																				 uint32_t(DebugInfoFlagIsPrivate)),
																 CASE_IEILLIIFIII(TypeComposite,
																				  Class,
																				  9,
																				  10,
																				  "FlagIsPrivate",
																				  uint32_t(DebugInfoFlagIsPrivate)),
																 CASE_IEILLIIFIIII(TypeComposite,
																				   Class,
																				   9,
																				   10,
																				   "FlagIsPrivate",
...
INSTANTIATE_TEST_CASE_P(
		...
		::testing::ValuesIn(std::vector<InstructionCase>({
																 CASE_IIILLIIIF(GlobalVariable, 1, 2, "FlagIsOptimized",
																				uint32_t(DebugInfoFlagIsOptimized)),
																 CASE_IIILLIIIF(GlobalVariable,
																				42,
																				43,
																				"FlagIsOptimized",
																				uint32_t(DebugInfoFlagIsOptimized)),
																 CASE_IIILLIIIFI(GlobalVariable,
																				 1,
																				 2,
																				 "FlagIsOptimized",
																				 uint32_t(DebugInfoFlagIsOptimized)),
...
INSTANTIATE_TEST_CASE_P(
		...
		::testing::ValuesIn(std::vector<InstructionCase>({
																 CASE_IIILLIIF(FunctionDeclaration,
																			   1,
																			   2,
																			   "FlagIsOptimized",
																			   uint32_t(DebugInfoFlagIsOptimized)),
