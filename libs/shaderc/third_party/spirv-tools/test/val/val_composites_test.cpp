...
spirv << "%deep = OpLoad %s_depth_" << depth << " %deep_var" <<
std::endl;
...
spirv << "%matrix = OpLoad %mat4x3 %my_matrix" <<
std::endl;
spirv << "%float_entry = OpCompositeExtract  %mat4x3 %matrix" <<
std::endl;
spirv << R"(OpReturn
              OpFunctionEnd)";
CompileSuccessfully(spirv
...
spirv << "%matrix = OpLoad %mat4x3 %my_matrix" <<
std::endl;
spirv << "%float_entry = OpCompositeExtract  %float %matrix" <<
std::endl;
spirv << R"(OpReturn
              OpFunctionEnd)";
CompileSuccessfully(spirv
...
spirv << "%matrix   = OpLoad %mat4x3 %my_matrix" <<
std::endl;
spirv << "%matrix_2 = OpLoad %mat4x3 %my_matrix" <<
std::endl;
