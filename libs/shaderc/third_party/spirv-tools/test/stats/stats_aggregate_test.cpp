...
EXPECT_EQ(4u, stats.capability_hist.
size()
);
EXPECT_EQ(0u, stats.capability_hist.
count(SpvCapabilityShader)
);
EXPECT_EQ(1u, stats.capability_hist.
at(SpvCapabilityAddresses)
);
EXPECT_EQ(1u, stats.capability_hist.
at(SpvCapabilityKernel)
);
EXPECT_EQ(1u, stats.capability_hist.
at(SpvCapabilityGenericPointer)
);
EXPECT_EQ(1u, stats.capability_hist.
at(SpvCapabilityLinkage)
);

CompileAndAggregateStats(code2, & stats
);
EXPECT_EQ(5u, stats.capability_hist.
size()
);
EXPECT_EQ(1u, stats.capability_hist.
at(SpvCapabilityShader)
);
EXPECT_EQ(1u, stats.capability_hist.
at(SpvCapabilityAddresses)
);
...
EXPECT_EQ(2u, stats.capability_hist.
at(SpvCapabilityLinkage)
);
...
EXPECT_EQ(3u, stats.capability_hist.
at(SpvCapabilityLinkage)
);
...
EXPECT_EQ(1u, stats.extension_hist.
size()
);
...
EXPECT_EQ(3u, stats.extension_hist.
size()
);
...
EXPECT_EQ(1u, stats.version_hist.
size()
);
...
EXPECT_EQ(2u, stats.version_hist.
size()
);
EXPECT_EQ(1u, stats.version_hist.at(0x00010100));
...
EXPECT_EQ(1u, stats.generator_hist.
size()
);
EXPECT_EQ(1u, stats.generator_hist.
at(kGeneratorKhronosAssembler)
);
...
EXPECT_EQ(2u, stats.generator_hist.
at(kGeneratorKhronosAssembler)
);
}
...
EXPECT_EQ(4u, stats.opcode_hist.
size()
);
EXPECT_EQ(4u, stats.opcode_hist.
at(SpvOpCapability)
);
EXPECT_EQ(1u, stats.opcode_hist.
at(SpvOpMemoryModel)
);
EXPECT_EQ(2u, stats.opcode_hist.
at(SpvOpTypeInt)
);
EXPECT_EQ(1u, stats.opcode_hist.
at(SpvOpTypeFloat)
...
EXPECT_EQ(5u, stats.opcode_hist.
size()
);
EXPECT_EQ(6u, stats.opcode_hist.
at(SpvOpCapability)
);
EXPECT_EQ(2u, stats.opcode_hist.
at(SpvOpMemoryModel)
...
EXPECT_EQ(10u, stats.opcode_hist.
at(SpvOpCapability)
);
EXPECT_EQ(3u, stats.opcode_hist.
at(SpvOpMemoryModel)
);
EXPECT_EQ(4u, stats.opcode_hist.
at(SpvOpTypeInt)
...
EXPECT_EQ(12u, stats.opcode_hist.
at(SpvOpCapability)
);
EXPECT_EQ(4u, stats.opcode_hist.
at(SpvOpMemoryModel)
...
ASSERT_EQ(2u, stats.opcode_markov_hist.
size()
);
EXPECT_EQ(2u, stats.opcode_markov_hist[0].
size()
);
EXPECT_EQ(2u, stats.opcode_markov_hist[0].
at(SpvOpCapability)
...
EXPECT_EQ(1u, stats.opcode_markov_hist[0].
at(SpvOpExtension)
.
size()
);
EXPECT_EQ(
1u, stats.opcode_markov_hist[0].
at(SpvOpCapability)
.
at(SpvOpCapability)
);
EXPECT_EQ(1u,
stats.opcode_markov_hist[0].
at(SpvOpCapability)
.
at(SpvOpExtension)
);
...
EXPECT_EQ(1u, stats.opcode_markov_hist[1].
size()
);
EXPECT_EQ(2u, stats.opcode_markov_hist[1].
at(SpvOpCapability)
.
size()
);
EXPECT_EQ(1u,
stats.opcode_markov_hist[1].
at(SpvOpCapability)
.
at(SpvOpExtension)
);
EXPECT_EQ(
1u, stats.opcode_markov_hist[1].
at(SpvOpCapability)
.
at(SpvOpMemoryModel)
);
...
EXPECT_EQ(4u, stats.opcode_markov_hist[0].
size()
);
EXPECT_EQ(3u, stats.opcode_markov_hist[0].
at(SpvOpCapability)
.
size()
);
...
EXPECT_EQ(3u, stats.opcode_markov_hist[1].
size()
);
EXPECT_EQ(4u, stats.opcode_markov_hist[1].
at(SpvOpCapability)
.
size()
);
...
EXPECT_EQ(2u, stats.f32_constant_hist.
size()
);
EXPECT_EQ(1u, stats.f64_constant_hist.
size()
);
...
EXPECT_EQ(2u, stats.u16_constant_hist.
size()
);
EXPECT_EQ(0u, stats.s16_constant_hist.
size()
);
EXPECT_EQ(1u, stats.u32_constant_hist.
size()
);
EXPECT_EQ(0u, stats.s32_constant_hist.
size()
);
EXPECT_EQ(1u, stats.u64_constant_hist.
size()
);
EXPECT_EQ(0u, stats.s64_constant_hist.
size()
);
...
EXPECT_EQ(3u, stats.u16_constant_hist.
size()
);
EXPECT_EQ(1u, stats.s16_constant_hist.
size()
);
EXPECT_EQ(1u, stats.u32_constant_hist.
size()
);
EXPECT_EQ(2u, stats.s32_constant_hist.
size()
);
EXPECT_EQ(1u, stats.u64_constant_hist.
size()
);
EXPECT_EQ(1u, stats.s64_constant_hist.
size()
);
