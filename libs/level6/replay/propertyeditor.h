#pragma once
#ifndef WYRD_REPLAY_PROPERTYEDITOR_H
#define WYRD_REPLAY_PROPERTYEDITOR_H
...
inline void PropertyEditJsonObject(nlohmann::json &j, const nlohmann::json &metaObj) {
...
inline void propertyEditor(nlohmann::json& j)
{
	using namespace nlohmann;
...
#endif //WYRD_REPLAY_PROPERTYEDITOR_H
