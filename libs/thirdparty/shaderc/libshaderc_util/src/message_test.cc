...
EXPECT_EQ("too many functions: got 1666473 of them", rest.
str()
);
...
EXPECT_EQ("version 1000 is unknown.", rest.
str()
);
}
...
EXPECT_EQ("0", segment_number.
str()
);
EXPECT_EQ("2", line_number.
str()
);
EXPECT_EQ("'#' : invalid directive: foo", rest.
str()
);
...
EXPECT_EQ("15", segment_number.
str()
);
EXPECT_EQ("36", line_number.
str()
);
...
EXPECT_EQ("shader.vert", source_name.
str()
);
EXPECT_EQ("5", line_number.
str()
);
EXPECT_EQ("something wrong", rest.
str()
);
...
EXPECT_EQ("0xdeedbeef", source_name.
str()
);
EXPECT_EQ("0", line_number.
str()
);
EXPECT_EQ("wa:ha:ha", rest.
str()
);
}
...
EXPECT_EQ(R"(C:\path\to\shader.glsl)", source_name.
str()
);
EXPECT_EQ("5", line_number.
str()
...
EXPECT_EQ(R"(\\path\without\drive.vert)", source_name.
str()
);
EXPECT_EQ("42", line_number.
str()
...
EXPECT_EQ(R"(X:\123.456\789)", source_name.
str()
);
EXPECT_EQ("0", line_number.
str()
