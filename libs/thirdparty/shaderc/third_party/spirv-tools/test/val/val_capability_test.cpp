...
if(
Exists(capability, SPV_ENV_UNIVERSAL_1_0
))
env = SPV_ENV_UNIVERSAL_1_0;
else if(
Exists(capability, SPV_ENV_UNIVERSAL_1_1
))
env = SPV_ENV_UNIVERSAL_1_1;
else if(
Exists(capability, SPV_ENV_UNIVERSAL_1_2
))
...
const std::string capability = Capability(GetParam());
if(
Exists(capability, SPV_ENV_VULKAN_1_0
)) {
const std::string test_code = MakeAssembly(GetParam());
...
const std::string capability = Capability(GetParam());
if(
Exists(capability, SPV_ENV_VULKAN_1_1
)) {
const std::string test_code = MakeAssembly(GetParam());
...
const std::string capability = Capability(GetParam());
if(
Exists(capability, SPV_ENV_OPENGL_4_0
)) {
const std::string test_code = MakeAssembly(GetParam());
