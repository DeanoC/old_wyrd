...
SinglePassRunAndCheck<InlineExhaustivePass>(predefs
+ before + nonEntryFuncs,
...
SinglePassRunAndCheck<InlineExhaustivePass>(assembly, assembly,
false, true);
}
...
SinglePassRunAndCheck<InlineExhaustivePass>(before, after,
false, true);
}
