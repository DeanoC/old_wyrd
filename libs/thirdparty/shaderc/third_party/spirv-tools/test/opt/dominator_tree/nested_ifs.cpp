...
EXPECT_TRUE(analysis
->StrictlyDominates(5, 8));
EXPECT_TRUE(analysis
->StrictlyDominates(5, 9));
EXPECT_TRUE(analysis
->StrictlyDominates(5, 21));
EXPECT_TRUE(analysis
->StrictlyDominates(8, 18));
EXPECT_TRUE(analysis
->StrictlyDominates(8, 10));
EXPECT_TRUE(analysis
->StrictlyDominates(8, 11));
EXPECT_TRUE(analysis
->StrictlyDominates(21, 23));
EXPECT_TRUE(analysis
->StrictlyDominates(21, 22));
EXPECT_TRUE(analysis
->StrictlyDominates(21, 26));
}
