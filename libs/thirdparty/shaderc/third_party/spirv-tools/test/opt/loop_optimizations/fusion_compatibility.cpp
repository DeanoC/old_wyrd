...
EXPECT_FALSE(LoopFusion(context.get(), loop_0, loop_0)
.
AreCompatible()
);
EXPECT_FALSE(LoopFusion(context.get(), loop_0, loop_2)
.
AreCompatible()
);
EXPECT_FALSE(LoopFusion(context.get(), loop_1, loop_0)
.
AreCompatible()
);
EXPECT_TRUE(LoopFusion(context.get(), loop_0, loop_1)
.
AreCompatible()
);
EXPECT_TRUE(LoopFusion(context.get(), loop_1, loop_2)
.
AreCompatible()
);
}
...
EXPECT_FALSE(LoopFusion(context.get(), loop_0, loop_1)
.
AreCompatible()
);
EXPECT_TRUE(LoopFusion(context.get(), loop_1, loop_2)
...
EXPECT_TRUE(LoopFusion(context.get(), loops[0], loops[1])
.
AreCompatible()
);
}
...
EXPECT_FALSE(LoopFusion(context.get(), loops[0], loops[1])
.
AreCompatible()
);
}
