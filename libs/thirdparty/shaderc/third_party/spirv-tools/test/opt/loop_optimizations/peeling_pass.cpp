...
EXPECT_EQ(peel_info
.first, LoopPeelingPass::PeelDirection::kBefore);
EXPECT_EQ(peel_info
.second, 2u);
}
{
...
EXPECT_EQ(peel_info
.first, LoopPeelingPass::PeelDirection::kAfter);
EXPECT_EQ(peel_info
.second, 2u);
}
{
...
run_test(SpvOpSGreaterThanEqual,
"%int_1", "%38",
{
{
LoopPeelingPass::PeelDirection::kBefore, 2u
