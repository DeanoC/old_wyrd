...
SinglePassRunAndCheck<AggressiveDCEPass>(
		predefs1
+ names_before + predefs2 + func_before,
...
SinglePassRunAndCheck<AggressiveDCEPass>(
		predefs1
+ names_before + predefs2_before + func_before,
...
SinglePassRunAndCheck<AggressiveDCEPass>(assembly, assembly,
true, true);
}
...
SinglePassRunAndCheck<AggressiveDCEPass>(defs_before
+ func_before,
...
SinglePassRunAndCheck<AggressiveDCEPass>(
		predefs_before
+ main_before, predefs_after + main_after, true, true);
}
...
SinglePassRunAndCheck<AggressiveDCEPass>(
		predefs_before
+ func_before, predefs_after + func_after, true, true);
}
...
SinglePassRunAndCheck<AggressiveDCEPass>(before, after,
true, true);
}
...
SetAssembleOptions(SPV_TEXT_TO_BINARY_OPTION_PRESERVE_NUMERIC_IDS);
SinglePassRunAndCheck<AggressiveDCEPass>(before, before,
true, true);
}
...
SetAssembleOptions(SPV_TEXT_TO_BINARY_OPTION_PRESERVE_NUMERIC_IDS);
SinglePassRunAndCheck<AggressiveDCEPass>(text, text,
false, true);
}
...
SetAssembleOptions(SPV_TEXT_TO_BINARY_OPTION_PRESERVE_NUMERIC_IDS);
SinglePassRunAndCheck<AggressiveDCEPass>(preamble
+ body_before,
...
SetAssembleOptions(SPV_TEXT_TO_BINARY_OPTION_PRESERVE_NUMERIC_IDS);
SinglePassRunAndCheck<AggressiveDCEPass>(test, test,
true, true);
}
...
SetAssembleOptions(SPV_TEXT_TO_BINARY_OPTION_PRESERVE_NUMERIC_IDS);
SinglePassRunAndCheck<AggressiveDCEPass>(test, result,
true, true);
}
