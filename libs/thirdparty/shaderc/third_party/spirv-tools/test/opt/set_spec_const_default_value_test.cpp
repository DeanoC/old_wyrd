...
SinglePassRunAndCheck<SetSpecConstantDefaultValuePass>(
		tc
.code, tc.expected, /* skip_nop = */ false, tc.default_values);
}
...
INSTANTIATE_TEST_CASE_P(
		...
		// 4. 64-bit uint type.
		{
		 ...
		 "%2 = OpSpecConstant %ulong 11\n",
				// default values
			 SpecIdToValueStrMap{{100, "18446744073709551614"},
								 {101, "0x100"}},
				// expected
											  "OpDecorate %1 SpecId 100\n"
											  "OpDecorate %2 SpecId 101\n"
		...
		// 5. 32-bit float type.
		{
		 ...
		 "%2 = OpSpecConstant %float 201\n",
				// default values
			 SpecIdToValueStrMap{{101, "-0x1.fffffep+128"},
								 {102, "2.5"}},
				// expected
											  "OpDecorate %1 SpecId 101\n"
											  "OpDecorate %2 SpecId 102\n"
		...
		// 16. Unchanged float default values
		{
		 ...
		 "%2 = OpSpecConstant %double 0.14285\n",
				// default values
			 SpecIdToValueStrMap{{201, "3.1415"},
								 {202, "0.14285"}},
				// expected
											  "OpDecorate %1 SpecId 201\n"
											  "OpDecorate %2 SpecId 202\n"
...
INSTANTIATE_TEST_CASE_P(
		...
		// 1. Empty with non-empty values to set.
		{"", SpecIdToValueBitPatternMap{{1, {100}},
										{2, {200}}}, ""},
		// 2. Baisc bool type.
		{
				// code
		 ...
		 "%2 = OpSpecConstantFalse %bool\n",
				// default values
			 SpecIdToValueBitPatternMap{{100, {0x0}},
										{101, {0x1}}},
				// expected
													 "OpDecorate %1 SpecId 100\n"
													 "OpDecorate %2 SpecId 101\n"
		...
		// 14. Unchanged bool default value
		{
		 ...
		 "%2 = OpSpecConstantFalse %bool\n",
				// default values
			 SpecIdToValueBitPatternMap{{100, {0x1}},
										{101, {0x0}}},
				// expected
													 "OpDecorate %1 SpecId 100\n"
													 "OpDecorate %2 SpecId 101\n"
		...
		// 15. Unchanged int default values
		{
		 ...
		 "%2 = OpSpecConstant %ulong 11\n",
				// default values
			 SpecIdToValueBitPatternMap{{100, {10}},
										{101, {11, 0}}},
				// expected
													 "OpDecorate %1 SpecId 100\n"
													 "OpDecorate %2 SpecId 101\n"
