...
void Viz::init(int32_t _argc, const char *const *_argv, uint32_t _width, uint32_t _height)
{
...

	{
		...
		testBundle.addRawTextChunk("test_chunk2", "TEST"_bundle_id, 0, 0, "bobbobobobobobobboboboboboboboboboboboobobobobobobobobobobobobobboboobboboboobboboboboboobboboobbobobobobobobobooosdfsdfdsfoobobEND\n");
		testBundle.addRawTextChunk("test_chunk3", "TEST"_bundle_id, 0, 1, "bAsadasdasdobobodsfjldjkladsjfdlskjfldasfjdlkfjdlkfjepi4-359345mvavdsaf435oboboboboobobobobobobobobobobobobobboboobboboboobboboboboboobboboobbobobobobobobobooosdfsdfdsfoobobEND\n");
				...
				{ {"TEST"_bundle_id, [&tests](uint16_t majorVersion_, uint16_t minorVersion_, size_t size_, void* ptr) -> bool
				  {
					  ...
					  if (minorVersion_ == 0) { 
						  char const* strings = (char const*)ptr;
						  assert(strcmp(strings, "bobbobobobobobobboboboboboboboboboboboobobobobobobobobobobobobobboboobboboboobboboboboboobboboobbobobobobobobobooosdfsdfdsfoobobEND\n") == 0);
					  }
					  if (minorVersion_ == 1) { 
						  char const* strings = (char const*)ptr;
						  assert(strcmp(strings, "bAsadasdasdobobodsfjldjkladsjfdlskjfldasfjdlkfjdlkfjepi4-359345mvavdsaf435oboboboboobobobobobobobobobobobobobboboobboboboobboboboboboobboboobbobobobobobobobooosdfsdfdsfoobobEND\n") == 0);
					  }
					  if (minorVersion_ == 2) { 
						  char const** strings = (char const**)ptr;
						  assert(strcmp(strings[0], "bob") == 0);
						  assert(strcmp(strings[1], "bob") == 0);
						  assert(strings[0] == strings[1]);
						  assert(strcmp(strings[2], "bob2") == 0);
						  assert(strcmp(strings[3], "bob3") == 0);
					  }
