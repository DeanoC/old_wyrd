...
#include <string>
void BINIFY_StringToOStream( std::string const& txt_, std::ostream *out_, std::string& log_ );
#endif
...
extern "C" uint8_t const *BINIFY_BinaryData( BINIFY_HANDLE * handle_ );
extern "C" void BINIFY_Free( BINIFY_HANDLE * handle_ );
